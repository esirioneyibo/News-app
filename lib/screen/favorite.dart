...
class FavoritesScreen extends StatefulWidget {
  ...
  FavoritesScreen({Key key, this.toolbarname}) : super(key: key);

  @override
  State<StatefulWidget> createState() => Favorites(toolbarname);
}
...
class Favorites extends State<FavoritesScreen> {
  List list = ['12', '11'];
